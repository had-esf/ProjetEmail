...
- HELO - Version basique, démarre la session (répond "250 OK") après un éventuel EHLO
...
Exemple de session SMTP - Version 2 (EHLO / HELO)
...
- 503 - Bad sequence of commands
 - 502 - Command not implemented (utilisé pour EHLO)
